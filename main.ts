...
function SchliesseDach () {
    ...
    pins.servoWritePin(AnalogPin.C5, 75)
    basic.pause(500)
    basic.setLedColor(0xffff00)
    basic.pause(500)
    basic.turnRgbLedOff()
    ...
    basic.pause(500)
    basic.turnRgbLedOff()
    pins.servoWritePin(AnalogPin.C5, 45)
    basic.pause(500)
    basic.setLedColor(0xffff00)
    basic.pause(500)
    basic.turnRgbLedOff()
    pins.servoWritePin(AnalogPin.C5, 30)
    basic.pause(500)
    basic.setLedColor(0xffff00)
    basic.pause(500)
    basic.turnRgbLedOff()
    pins.servoWritePin(AnalogPin.C5, 15)
    basic.pause(500)
    basic.setLedColor(0xffff00)
    basic.pause(500)
    basic.turnRgbLedOff()
    pins.servoWritePin(AnalogPin.C5, 5)
...
function OeffneDach () {
    ...
    basic.pause(500)
    basic.turnRgbLedOff()
    pins.servoWritePin(AnalogPin.C5, 85)
